...
public class WebTableHandler 
{
    ...
    public static void main(String[] args) 
    {
        ...
        // Locate the table
        By tableLocator = By.xpath("//table/tbody");
        ...
        // Verify data exists
        boolean isPresent = tableHandler.isDataPresent(table, "Firefox");
        System.out.println("Data Present: " + isPresent);

        
        String Data=tableHandler.getAllTableData(table).get(1).get(0);
