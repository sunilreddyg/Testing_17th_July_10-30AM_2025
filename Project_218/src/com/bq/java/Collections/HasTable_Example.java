...
public class HasTable_Example {
	...
	public static void main(String[] args) {
		...
		//Check value avaialability
		boolean flag1=map.containsValue("1999");
		System.out.println("value available status is --> "+flag1);
